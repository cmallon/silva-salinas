	...
	<div class="footer">
		...
		<div class="flex flex-col-reverse md:flex-row space-y-reverse space-y-8 md:space-y-0 md:space-x-8 justify-between w-full">
			...
			<div class="footer-links">
				...
				{
				?>
					<div class='links'><a href="<?php echo $item->url ?>"><?php echo $item->title ?></a></div>
				<?php
				}
				?> 
			</div>  
